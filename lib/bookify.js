                        ...
                        if (elem.hasOwnProperty(tag)) {
                            ...
                            if (tag === 'img') {
                                ...
                                if (wordcount + newcount <= LOWER_WORD_LIMIT) {
                                    ...
                                    console.log("greater than lower limit");
                                    if (wordcount + newcount <= UPPER_WORD_LIMIT) {
                                        console.log("less than upper limit");
                                        html += '<' + tag + '>' + elem[tag] + '</' + tag + '>';
                                        ...
                                        console.log("greater than upper limit");
                                        ...
                                        do {
                                            ...
                                            if (content.indexOf('.') !== -1) {
                                                let nearestDot = content.indexOf('.', availableRoom*5);
                                                ...
                                                if (wc(leftPartSentence) - availableRoom > 7) { // one line extra only.
                                                    ...
                                                    rightPartSentence = elem[tag].substr(nearestDot + 1);
                                            ...
                                            if(rightWordCount > UPPER_WORD_LIMIT) {
