                                ...
                                if (wordcount + newcount <= LOWER_WORD_LIMIT) {
                                    ...
                                    if (wordcount + newcount <= UPPER_WORD_LIMIT) {
                                        ...
                                        if (elem[tag].indexOf('.') !== -1) {
                                            let nearestDot = elem[tag].indexOf('.', availableRoom);
                                            
                                            let leftPartSentence = elem[tag].substr(0, nearestDot + 1);
                                            ...
                                            let wordsArray  = elem[tag].split(' ');
                                            
                                            let leftPartSentence = wordsArray.slice(0, availableRoom).join(' ');

                                            let rightPartSentence = wordsArray.slice(availableRoom).join(' ');
